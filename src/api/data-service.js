...
export default {
  ...
  getCompany(id, success, failure) {
    networkClient.get('company/${id}', success, failure, id);  
  }, 
  getProfileDetails(id, success, failure) {
    networkClient.get(`person/${id}`, success, failure, id);
  },  
};
