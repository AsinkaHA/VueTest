...
export default {
  ...
  [actions.GET_POPULAR_TV]({commit}, params = {}) {
    commit(mutations.SET_LOADER, true);
    dataService.getPopularTV(
      params,
      (response) => {
        console.log(response);
        commit(mutations.SET_TV, response.results);
        commit(mutations.SET_LOADER, false);
      },
      (error) => {
        console.log(error);
  ...
  [actions.GET_COMPANY]({commit}, id) {
    commit(mutations.SET_LOADER, true);
    dataService.getCompany(
      id,
      (responseCompany) => {
        commit(mutations.SET_COMPANY, responseCompany);
        commit(mutations.SET_LOADER, false);
      },
      (error) => {
        console.log(error);
  ...
  [actions.GET_PROFILE_DETAILS]({commit}, id) {
    commit(mutations.SET_LOADER, true);
    dataService.getPeopleDetails(
      id,
      (responsePeople) => {
        commit(mutations.SET_CURRENT_PROFILE, responseProfile);
        commit(mutations.SET_LOADER, false);
      },
      (error) => {
        console.log(error);
